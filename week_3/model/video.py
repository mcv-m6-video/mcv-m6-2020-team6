...
from week_3.model.bbox import BBox
...
class Video:
    ...
    def getgt_detections(directory_txt,num_frames):
        ...
        for line in txt_gt:
            ...
            Boxes_list.append(BBox(frameid, label, topleft, width, height, confidence, id_det))
    ...
    def getgroundTruthown(directory_txt, ini_frames,end_frames):
        ...
        for line in txt_gt:
            ...
            height = float(splitLine[5])
            confidence = float(splitLine[6])
            det_id = int(splitLine[7])
            Boxes_list.append(BBox(frameid, label, topleft, width, height, confidence, det_id))
