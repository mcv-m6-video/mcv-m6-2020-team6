...
def iou_frame(detections_frame: Frame, gt_frames: Frame, thres):
    ...
    for u in gt_frames.bboxes:

        ious = []
        """bboxes=detections_frames.get_bboxes()
        for i in bboxes:"""
        for i in detections_frame.bboxes:
            # print(u)
            # print(i)
...
# https://github.com/tensorflow/models/blob/fe748d4a4a1576b57c279014ac0ceb47344399c4/research/object_detection/utils/metrics.py
...
def mAP_tensorflow(gt: Video, detections: Video):
    ...
    for i in bbox_detected:
        ...
        recall.append(float(TP / len(bbox_gt)))
